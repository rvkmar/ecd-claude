// EvidenceWizard/WizardStepContainer.jsx
// 🧩 Wizard Step Container (Canonical Wizard Chrome — Enterprise Visual System)
// ------------------------------------------------------------
// Same shell as competencies/CompetencyWizard/WizardStepContainer.jsx
// so all four model wizards look and behave identically:
//  • Nav bar (Cancel/OK, step indicator + progress rail, Back/Next/
...
//    draft first (see EvidenceWizard.jsx's goNext); Lock & Confirm
//    does the same if anything changed since the last auto-save.
...
export default function WizardStepContainer({
    ...
    /* =====================================================
       ...
       already wraps the draft save -- see EvidenceWizard.jsx)
    ===================================================== */
        ...
        return (
            <div className="sticky top-0 z-20 border-b border-slate-200 bg-white">
                <div className="flex items-center justify-between gap-4 px-8 py-4">
                    ...
                    >
                        {canEdit && <X size={15} strokeWidth={2.25} />}
                        {canEdit ? "Cancel" : "OK"}
                    </button>
                ...
                <div className="mx-auto max-w-5xl">
                    ...
                    {locked && (
                        <div className="mt-8 flex items-start gap-3 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3.5 text-sm text-emerald-800">
                            ...
                            <span>
                                This Evidence Model is confirmed and locked.
